...
router.put('/prosumer.js/:id/consumption', async (req, res) => {
...
router.get('/prosumer.js/consumption', async (req, res) => {
    try {
...
// Get prosumer.js consumption by id
router.get('/prosumer.js/:id/consumption', async (req, res) => {
    try {
...
// PRODUCTION
// Update prosumer.js production by id
router.put('/prosumer.js/:id/production', async (req, res) => {
    try{
...
router.get('/prosumer.js/production', async (req, res) => {
    try {
        const prosumers = await server_db_utils.getAllProsumers()
...
// Get prosumer.js production by id
router.get('/prosumer.js/:id/production', async (req, res) => {
    try {
        const prosumer = await server_db_utils.getProsumerById(req.params.id)
        if (prosumer == null) {
            res.status(404).send()
...
// NET PRODUCTION
// Get prosumer.js net production by id
router.get('/prosumer.js/:id/net_production', async(req, res) => {
    try {
        const prosumer = await server_db_utils.getProsumerById(req.params.id)
        if(prosumer == null){
            res.status(404).send()
...
// BUFFER
// Get prosumer.js buffer by id
router.get('/prosumer.js/:id/buffer', async (req, res) => {
    try {
        const prosumer = await server_db_utils.getProsumerById(req.params.id)
        if(prosumer == null){
            res.status(404).send()
...
// Update prosumer.js buffer by id
router.put('/prosumer.js/:id/buffer', async (req, res) => {
...
// Get prosumer.js max buffer by id
router.get('/prosumer.js/:id/buffer_max', async (req, res) => {
    try {
        const prosumer = await server_db_utils.getProsumerById(req.params.id)
        if(prosumer == null){
            res.status(404).send()
...
// Update prosumer.js max buffer by id
router.put('/prosumer.js/:id/buffer_max', async (req, res) => {
    try{
